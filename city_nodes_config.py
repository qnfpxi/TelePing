...
def get_node_config():
    ...
    参考官方示例，只使用核心省份的 pro_ids：
    - 北京(180)、上海(221)、广东(195)、浙江(355)、江苏(357)
    - 四川(353)、湖北(235)、陕西(194)
    共8个核心省份，覆盖全国主要地区

    参数说明：
    - pro_ids: 省份ID数组（官方API支持，8个核心省份）
    - num: 每个省份分配节点数
    ...
    """
    # 8个核心省份：北上广浙苏川鄂陕
    core_provinces = [180, 221, 195, 355, 357, 353, 235, 194]

    return {
        "pro_ids": core_provinces,  # 8个核心省份
        "num": 3,                    # 每省3个节点，约24个节点/次
