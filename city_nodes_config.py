...
def get_node_config():
    ...
    标准配置：14个核心省份，覆盖全国主要地区
    - 4个直辖市：北京(180)、上海(221)、重庆(49)、天津(243)
    - 东部沿海：广东(195)、浙江(355)、江苏(357)、山东(190)、福建(79)
    - 中西部枢纽：四川(353)、湖北(235)、河南(196)、湖南(350)、陕西(194)

    参数说明：
    - pro_ids: 省份ID数组（官方API参数，14个核心省份）
    - num: 每个省份分配节点数
    ...
    """
    # 14个核心省份：4直辖市 + 10个经济/交通枢纽省份
    core_provinces = [
        180, 221, 195, 355, 357,  # 北京、上海、广东、浙江、江苏
        353, 235, 194,             # 四川、湖北、陕西
        49, 243,                   # 重庆、天津（直辖市）
        190, 79, 196, 350          # 山东、福建、河南、湖南
    ]

    return {
        "pro_ids": core_provinces,  # 14个核心省份
        "num": 3,                    # 每省3个节点，约40-55个节点/次
